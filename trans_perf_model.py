...
from pacsltk.perfmodel import ErlangB
...
def get_sls_props_transient(arrival_rate, warm_service_time, cold_service_time, idle_time_before_kill, maximum_concurrency=1000, faster_solution=True, max_t=300, init_server_count=0):    
    ...
    while server_count < server_max:
        ...
        if faster_solution:
            ...
            if server_max < init_server_count:
                server_max = init_server_count
    ...
    # Source: https://vknight.org/blog/posts/continuous-time-markov-chains/
    init_state = np.zeros((1, states_counts))
    init_state[0,init_server_count] = 1
